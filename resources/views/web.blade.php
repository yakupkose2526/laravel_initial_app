        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ml-auto my-2 my-lg-0">
                    <li class="nav-item"><a class="nav-link js-scroll-trigger" href={{ route('about') }} >Hakkımızda</a></li>
                    <li class="nav-item"><a class="nav-link js-scroll-trigger" href={{ route('services') }}>Hizmetler</a></li>
                    <li class="nav-item"><a class="nav-link js-scroll-trigger" href={{ route('portfolio') }}>Portfolio</a></li>
                    <li class="nav-item"><a class="nav-link js-scroll-trigger" href={{ route('contact') }}>İletişim</a></li>
                </ul>
            </div>
        </div>
    </nav>
